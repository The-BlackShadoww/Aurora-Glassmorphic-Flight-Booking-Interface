...
import { Plane, User, Armchair, CreditCard, Check } from 'lucide-react';
...
const steps: Step[] = [
    ...
    { id: 2, title: 'Passengers', icon: User },
                        ...
                        <div key={step.id} className="flex flex-col items-center z-10">
                            <motion.div
                                className={cn(
                                    ...
                                    isCompleted && 'bg-gradient-to-br from-purple-500 to-pink-500 border-purple-400',
